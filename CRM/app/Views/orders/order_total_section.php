<table id="order-item-table" class="table display dataTable text-right strong table-responsive no-body-top-bottom-border">     
    <tr>
    ...
    $total_after_discount_row = "<tr>
                                    ...
                                    <td style='width:120px;'>" . to_currency($order_total_summary->order_subtotal - $order_total_summary->discount_total) . "</td>
                                    <td></td>
                                </tr>";
    ...
    if ($order_total_summary->order_subtotal && (!$order_total_summary->discount_total || ($order_total_summary->discount_total !== 0 && $order_total_summary->discount_type == "before_tax"))) {
        ...
        if ($order_total_summary->discount_total !== 0) {
